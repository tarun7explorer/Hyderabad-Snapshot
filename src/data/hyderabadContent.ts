...
export const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "tollywood", name: "Telugu Cinema", description: "The massive film production center.", image: "/famous_places/Ramoji Fillm City.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "kbr", name: "KBR National Park", description: "Urban jungle sanctuary.", image: "/Adventure/Ananthagiri Hills.jpg" },
